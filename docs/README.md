...
| 문서 | 내용 |
|---|---|
| **[01. 차트 포맷과 에셋](01-차트-포맷과-에셋.md)** | 텍스트 저작 포맷, `.spc` 바이너리, StreamingAssets 매핑 |
...
| **[04. 후킹 함정과 성능](04-후킹-함정과-성능.md)** | 크래시를 유발하는 후킹 패턴, 덤프 스텁의 거짓말, 프레임 드랍 |
...
| 영역 | 상태 | 난이도 |
|---|---|---|
| **곡 오디오** | `sam/` 전체가 파일별로 암호화돼 파일 교체는 **실패**. 대신 게임 FMOD 에 `ignoresetfilesystem` 으로 평문 OGG 직접 재생 **성공** | **보통** (게임 파이프라인에 끼워 넣기가 남음) — [03번](03-판정-오디오-세이브.md) 2장 |
